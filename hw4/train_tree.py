...
def train_tree_greedy(
    ...
    if depth >= MAX_DEPTH:
        ...
        if feat_id is None:
            ...
            left_child = train_tree_greedy(x_LF, y_L, depth + 1, MAX_DEPTH, MIN_SAMPLES_INTERNAL, MIN_SAMPLES_LEAF)
            # TODO recursively call train_tree_greedy to build the right child
            right_child = train_tree_greedy(x_RF, y_R, depth + 1, MAX_DEPTH, MIN_SAMPLES_INTERNAL, MIN_SAMPLES_LEAF)
